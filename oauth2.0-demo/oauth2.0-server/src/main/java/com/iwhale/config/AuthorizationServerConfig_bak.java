 ...
 * @since V8.1<br>
 * @see AuthorizationServerConfig_bak <br>
 *
 *     http://localhost:8080/oauth/authorize?response_type=code&client_id=clientId_1&redirect_uri=https://www.baidu.com/
 */
// @Configuration
// @EnableAuthorizationServer
//public class AuthorizationServerConfig_bak extends AuthorizationServerConfigurerAdapter {
public class AuthorizationServerConfig_bak  {
